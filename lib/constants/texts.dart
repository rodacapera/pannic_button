abstract class TextConstants {
  static String nameApp = 'Panic Button';
  static String allow = 'Permitir';
  static String await = 'Espere por favor...';
  static String panicButton = 'Panic';
  static String back = 'Volver';
  static String ops = 'Oops...';
  static String products = 'Products';
  static String productName = 'Nombre del producto';
  static String name = 'Nombre';
  static String price = 'Precio';
  static String available = 'Disponible';
  static String login = 'Ingreso';
  ...
  static String requiredName = 'El nombre es obligatorio';
  static String searchCountry = 'Buscar país';
  static String editProfile = 'Editar Perfil';
  static String profile = 'Perfil';
  static String john = 'John';
  static String doe = 'Doe';
  static String lastnames = 'Apellidos';
  static String canNotBeEmpty = 'Este campo no puede quedar vacio';
  ...
  static String state = 'Departamento';
  static String testState = 'NY';
  static String testEmail = 'john.doe@email.com';
